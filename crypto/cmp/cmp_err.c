...
static const ERR_STRING_DATA CMP_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_HDR_GET_PVNO, 0),
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_HDR_SET_PVNO, 0),
...
static const ERR_STRING_DATA CMP_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_CMP, 0, CMP_R_BAD_PVNO), "bad pvno"},
    {ERR_PACK(ERR_LIB_CMP, 0, CMP_R_BAD_REQUEST_ID), "bad request id"},
    {ERR_PACK(ERR_LIB_CMP, 0, CMP_R_BAD_STATUS), "bad status"},
    ...
    {ERR_PACK(ERR_LIB_CMP, 0, CMP_R_UNEXPECTED_STATUS), "unexpected status"},
